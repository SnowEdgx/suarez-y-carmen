...
export default function SecureVideoPlayer({ src, title }: SecureVideoPlayerProps) {
  ...
  return (
    <div className="relative mx-auto max-w-[380px] overflow-hidden rounded-2xl border border-neutral-700 bg-black shadow-2xl shadow-black/30 sm:max-w-[420px] md:mx-0 lg:max-w-[440px] xl:max-w-[460px]">
      <video
        key={`${src}-${reloadNonce}`}
        ref={videoRef}
        aria-label={title}
