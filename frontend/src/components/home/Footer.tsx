    ...
    <footer className="border-t border-neutral-900 bg-black pt-16 pb-8 px-6 md:px-12">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
        <div className="md:col-span-2">
          <Link href="/" className="text-3xl font-bold font-serif text-white tracking-tight mb-4 inline-block">S&C</Link>
          <p className="text-neutral-400 max-w-sm">
            Formación profesional de bachata online. Perfecciona tu técnica y estilo con nuestra metodología desde cualquier lugar.
          </p>
          <div className="mt-8">
            <a
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm text-neutral-400">
            ...
            <li><Link href="#" className="hover:text-white transition-colors">Regala un curso</Link></li>
          </ul>
        </div>
      ...
      <div className="max-w-7xl mx-auto pt-8 border-t border-neutral-900 text-center md:flex-row justify-between items-center text-xs text-neutral-600">
